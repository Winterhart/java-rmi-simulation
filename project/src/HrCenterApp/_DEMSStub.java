...
public class _DEMSStub extends org.omg.CORBA.portable.ObjectImpl implements HrCenterApp.DEMS
{
  ...
  public String createMRecord (String firstName, String lastName, String employeeID, String mailID, String managerID, HrCenterApp.DEMSPackage.Project[] projects, HrCenterApp.DEMSPackage.ServerLocation location)
  {
            ...
            try {
                ...
                return createMRecord (firstName, lastName, employeeID, mailID, managerID, projects, location        );
            } finally {
                _releaseReply ($in);
            }
  } // createMRecord
