                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // HrCenterApp/DEMS/createMRecord
       {
         ...
         HrCenterApp.DEMSPackage.Project project = HrCenterApp.DEMSPackage.ProjectHelper.read (in);
         String $result = null;
         $result = this.createMRecord (firstName, lastName, employeeID, mailID, managerID, project);
         out = $rh.createReply();
       ...
       case 1:  // HrCenterApp/DEMS/createERecord
       {
         ...
         String managerID = in.read_wstring ();
         String $result = null;
         $result = this.createERecord (firstName, lastName, employeeID, mailID, projectID, location, managerID);
         out = $rh.createReply();
         out.write_wstring ($result);
         break;
       }
