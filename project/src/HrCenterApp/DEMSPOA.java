 ...
 implements HrCenterApp.DEMSOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("managerLogin", new java.lang.Integer (6));
    _methods.put ("getWelcomeMessage", new java.lang.Integer (7));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // HrCenterApp/DEMS/createMRecord
       {
         ...
         HrCenterApp.DEMSPackage.ServerLocation location = HrCenterApp.DEMSPackage.ServerLocationHelper.read (in);
         String managerAuthorOfRequest = in.read_wstring ();
         String $result = null;
         $result = this.createMRecord (firstName, lastName, employeeID, mailID, managerID, projects, location, managerAuthorOfRequest);
         out = $rh.createReply();
       ...
       case 5:  // HrCenterApp/DEMS/shutdown
       {
         String managerID = in.read_wstring ();
       ...
       case 6:  // HrCenterApp/DEMS/managerLogin
       {
         String managerID = in.read_wstring ();
       ...
       case 7:  // HrCenterApp/DEMS/getWelcomeMessage
       {
         String managerID = in.read_wstring ();
         String $result = null;
